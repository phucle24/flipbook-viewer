...
const FlipbookLayout: React.FC<FlipbookLayoutProps> = ({ story = sampleStory }) => {
  ...
  return (
    <>
      <button
        onClick={() => setHCMode((v) => !v)}
        className="fixed left-2 bottom-2 z-50 rounded-full bg-[#000] text-[#ffe600] p-3 shadow-md border-2 border-[#ffe600] hover:scale-105 focus:ring-4 focus:ring-[#ffe600]/40 transition-all"
        style={{ fontWeight: 700, fontSize: 17 }}
        aria-label={hcMode ? "Turn off high contrast color scheme" : "Enable high contrast color scheme (yellow on black)"}
        title={hcMode ? "Turn off high contrast color scheme" : "Enable high contrast for visually impaired"}
      >
        {hcMode ? '🌑 Normal' : '🦯 Contrast'}
      </button>
      <div
      ...
      >
        ...
        <div className="relative flex flex-1 flex-col items-center justify-center">
          <div className="relative flex w-full flex-1 items-center justify-center">
            ...
            <button
              ...
              className={`absolute left-1 sm:left-4 top-1/2 z-10 -translate-y-1/2 rounded-full p-1 sm:p-2 text-white opacity-80 transition-all hover:opacity-100 ${currentPage === 1 ? 'cursor-not-allowed opacity-40' : 'hover:scale-105'}`}
              style={{
                height: isMobile ? 48 : 64,
                width: isMobile ? 48 : 64,
                fontSize: isMobile ? 24 : 32,
                border: hcMode ? '3px solid #ffe600' : '3px solid #FFD1BA',
                outline: hcMode ? '2.5px solid #ffe600' : '2.5px solid #383b3a',
                backgroundColor: hcMode ? '#000' : '#3584F6',
                color: hcMode ? '#ffe600' : undefined,
                boxShadow: '0 2px 14px #CDEDF680',
              ...
              title="Previous page (←)"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-${isMobile ? '9' : '12'} w-${isMobile ? '9' : '12'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
              ...
              className={`absolute right-1 sm:right-4 top-1/2 z-10 -translate-y-1/2 rounded-full p-1 sm:p-2 text-white opacity-80 transition-all hover:opacity-100 ${currentPage >= totalPages - 1 ? 'cursor-not-allowed opacity-40' : 'hover:scale-105'}`}
              style={{
                height: isMobile ? 48 : 64,
                width: isMobile ? 48 : 64,
                fontSize: isMobile ? 24 : 32,
        ...
        <div className="fixed bottom-20 right-4 z-30 flex flex-col space-y-2 sm:hidden">
          {/* Animation Style Button - for mobile */}
          <button
            onClick={() => setShowAnimationStyleControls(!showAnimationStyleControls)}
            className="rounded-full bg-white p-2 shadow-lg transition-transform hover:scale-105 focus:ring-2 focus:ring-blue-300"
            aria-label="Show animation style options"
            aria-pressed={showAnimationStyleControls}
            title="Choose page turn animation style"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            className={`rounded-full p-2 shadow-lg transition-transform hover:scale-105 focus:ring-2 focus:ring-blue-300 ${
        ...
        {/* Animation Style Button - for desktop */}
        <button
          onClick={() => setShowAnimationStyleControls(!showAnimationStyleControls)}
          tabIndex={0}
          aria-label="Show animation style options"
          aria-pressed={showAnimationStyleControls}
          className="fixed bottom-16 right-28 z-20 hidden sm:flex rounded-full bg-white p-2 shadow-lg transition-transform hover:scale-105 focus:ring-2 focus:ring-blue-200"
          title="Choose page turn animation style"
          data-tooltip="Choose animation style"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1M4 7l2-1M4 7l2 1M4 7v2.5M12 21l-2-1m2 1l2-1m-2 1v-2.5M6 18l-2-1v-2.5M18 18l2-1v-2.5" />
          </svg>
        ...
        {showAnimationStyleControls && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm sm:bg-transparent sm:backdrop-blur-none sm:p-0 sm:block sm:inset-auto sm:bottom-28 sm:right-28">
            <div
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <span className="text-2xl mb-1">🔄</span>
                  <span className="mt-1 text-sm font-medium">Flip</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="mt-1 text-sm font-medium">Slide</span>
                </button>
              </div>
            </div>
          </div>
